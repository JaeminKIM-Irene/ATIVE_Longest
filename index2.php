    ...
    <script>
        ...
        $(window).on('scroll', function() {
            ...
            if ($(window).scrollTop() > 300) {
                ...
                $('.icon3-2').css({"animation": "flyIn4 1.3s ease-out", "animation-fill-mode":"forwards", "animation-delay": "0.75s"});
            }
            else {
            ...
            //가입안내 섹션에서 플로팅버튼 숨기기
            if ($(window).scrollTop() > offset.top-95 || $(window).scrollTop()+$(window).innerHeight() >= $('body').prop('scrollHeight')){
                $('.floating_container').css({"display":"none"});
            }
            else {
                $('.floating_container').css({"display":"block"});
            }
        })
            ...
            <div class="content4_background">
                ...
                <div class="main_content4">
                    ...
                    <div class="bubble_container1">
                        <div class="text_bubble1"><div class="bubble_underline">스크린 홀인원 때도 상금</div>을 받고 싶어요</div>
                        <img src="./image/emoji1.png" class="emoji1" />
                    </div>
                    <div class="bubble_container2">
                        <img src="./image/emoji2.png" class="emoji2" />
                        <div class="text_bubble2">불필요한 보장성 내용은 빼고<br><div class="bubble_underline">저렴하게 홀인원 상금만</div> 받고싶어요</div>
                    </div>
                    <div class="bubble_container3">
                        <div class="text_bubble3"><div class="bubble_underline">일회성이 아닌 무제한 보상</div>을 받고싶어요</div>
